...
<td>
		...
		<tr>
		<td></td>
		<td><input type="button" name="select" id="select" class="com-button" value="Pilih" onclick="window.location='<?php echo basename($_SERVER['PHP_SELF']);?>?option=select&class_id=<?php echo $data['class_id'];?>'" /> 
...
include_once dirname(dirname(__FILE__))."/lib.inc/footer.php";
