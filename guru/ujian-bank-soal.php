...
<div class="collection-list">
        ...
        <div class="file-list">
        	<ul>
				...
				if($stmt2->rowCount() > 0)
				{
					...
					{
					?>
					<li><a href="#" data-id="<?php echo $data2['test_collection_id'];?>"><?php echo $data2['name'];?></a></li>
					<?php
					}
				}
				?>
    ...
    <div class="collection-preview-container" data-id="0">
        ...
        <div class="test-selector-wrapper">
			...
			from `edu_test`
			where 1 and `edu_test`.`school_id` = '$school_id' and `edu_test`.`teacher_id` = '$auth_teacher_id'
