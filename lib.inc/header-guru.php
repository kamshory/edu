	...
	<div class="header">
    	...
    	<div class="menu menu-left">
    	  <ul>
    	    ...
    	    <li><a href="guru/sekolah.php">Sekolah</a></li>
    	    <li><a href="guru/kelas.php">Kelas</a></li>
    	    <li><a href="guru/siswa.php">Siswa</a></li>
    	    <li><a href="guru/guru.php">Guru</a></li>
    	    <li><a href="guru/artikel.php">Artikel</a></li>
    	    <li><a href="guru/ujian.php">Ujian</a></li>
  	      </ul>
    	</div>
    	<div class="menu menu-right">
    	  <ul>
			...
			{
			?>
    	    <li><a href="guru/profil.php">Profil</a></li>
            <?php
			}
			?>
            <?php
