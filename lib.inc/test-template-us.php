...
$number_of_question = $stmt2->rowCount();
$no_halaman_awal = 0;
$no_halaman_akhir = 0;
...
<div class="option-item">
<div class="option-ctrl">
<label><input type="radio" data-test="<?php echo $test_id; ?>" data-question="<?php echo $soal; ?>" name="answer_<?php echo $data['question_id']; ?>" id="answer_<?php echo $data['question_id']; ?>" class="radio_answer" value=""<?php 
if ($answer == '')
{
