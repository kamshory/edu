...
else
{
	...
	if(@$student_id)
	{
		include_once dirname(__FILE__)."/lib.inc/header-siswa.php";
		?>
		<ul class="shortcut-image-80">
			...
			<li><a href="siswa/kelas.php"><div><img alt="img" src="lib.assets/theme/default/css/images/class-80.png" /></div><div class="menu-label">Kelas</div></a></li>
			<li><a href="siswa/siswa.php"><div><img alt="img" src="lib.assets/theme/default/css/images/students-80.png" /></div><div class="menu-label">Siswa</div></a></li>
			<li><a href="siswa/guru.php"><div><img alt="img" src="lib.assets/theme/default/css/images/teachers-80.png" /></div><div class="menu-label">Guru</div></a></li>
			<li><a href="siswa/artikel.php"><div><img alt="img" src="lib.assets/theme/default/css/images/article-80.png" /></div><div class="menu-label">Artikel</div></a></li>
			<li><a href="siswa/info.php"><div><img alt="img" src="lib.assets/theme/default/css/images/news-80.png" /></div><div class="menu-label">Info</div></a></li>
			<li><a href="siswa/ujian.php"><div><img alt="img" src="lib.assets/theme/default/css/images/exam-80.png" /></div><div class="menu-label">Ujian</div></a></li>
			<li><a href="siswa/profil.php"><div><img alt="img" src="lib.assets/theme/default/css/images/profile-80.png" /></div><div class="menu-label">Profil</div></a></li>
			<li><a href="siswa/logout.php"><div><img alt="img" src="lib.assets/theme/default/css/images/logout-80.png" /></div><div class="menu-label">Logout</div></a></li>
		</ul>
		<?php
		include_once dirname(__FILE__)."/lib.inc/footer-siswa.php";
		exit();
	}
	...
	if(!$loged_in)
	{
		...
		if(@$teacher_id)
		{
			include_once dirname(__FILE__)."/lib.inc/header-guru.php";
			?>
			<ul class="shortcut-image-80">
				<li><a href="./"><div><img alt="img" src="lib.assets/theme/default/css/images/home-80.png" /></div><div class="menu-label">Depan</div></a></li>
			...
			<?php
			include_once dirname(__FILE__)."/lib.inc/footer-guru.php";
			exit();
		}
	}
	...
	if(!$loged_in)
	{
		...
		if(@$admin_id)
		{
			include_once dirname(__FILE__)."/lib.inc/header-admin.php";
			?>
			<ul class="shortcut-image-80">
				<li><a href="./"><div><img alt="img" src="lib.assets/theme/default/css/images/home-80.png" /></div><div class="menu-label">Depan</div></a></li>
			...
			<?php
			include_once dirname(__FILE__)."/lib.inc/footer-admin.php";
			exit();
		}
	}
